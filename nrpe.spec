...
%changelog
* Tue Oct 16 2018 Stephen Smoogen <smooge@fedoraproject.org> - 3.2.1-8
- Remove stray entries in selinux te. They were added before they were ready

* Mon Oct 15 2018 Stephen Smoogen <smooge@fedoraproject.org> - 3.2.1-7
- Try to fix nrpe.service file not to cause errors for older clients.
- Work with averi to work out kinks. [Many thanks to averi for the time]
...
- NRPE fails to run using a /var/run/nrpe/ directory so trying to
build without it.
